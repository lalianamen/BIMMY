...
- Never duplicate the same character in one shot.
- Keep age, height relationships, hairstyle, clothing, and recognizable facial details stable.
- If a recurring character is not part of the approved script, do not add them automatically.

## 3. Episode format
- Default social format: vertical 9:16.
...
- Do not remove dialogue, reorder scenes, shorten key jokes, or invent major new plot points without explicit approval.
- Every important line, reaction, prop, gesture, and final punchline must be represented.
- When a scene depends on pantomime, facial expression, or silence, preserve those beats exactly.

## 5. Comedy direction
- BIMMY should usually play absurd situations seriously. The contrast creates the humor.
...
- Use medium shots and close-ups for dialogue and facial comedy.
...
- Keep accents and imperfect English when they are part of the joke.
- Use light background music under dialogue, not overpowering speech.
- Sound effects should support the scene but remain subtle unless a stronger comedic beat is required.
- Avoid random subtitles or text overlays unless specifically requested.
...
- All required script beats are included.
- No missing dialogue.
- No accidental extra characters.
- No unwanted sunglasses indoors when facial acting matters.
- Final scene and punchline are included.
- Output format is correct for the target platform.
...
- Use short hook text, ideally 3–7 words.

## 10. Reusable episode structure
1. Hook: visual problem or awkward situation.
2. Setup: BIMMY confidently enters the situation.
3. Complication: misunderstanding or everyday problem becomes funnier.
4. Reaction beat: supporting character reacts.
5. Escalation: BIMMY doubles down or improvises.
6. Resolution: she gets what she wanted or thinks she succeeded.
7. Final punchline: short confident BIMMY line, look, gesture, or silent visual beat.
